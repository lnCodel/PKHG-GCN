...
class OptInit():
    def __init__(self):
        parser = argparse.ArgumentParser(description='PyTorch implementation of PKIG-GCN')
        ...
        parser.add_argument('--lg', type=int, default=5, help='number of gconv layers')
        parser.add_argument('--lg1', type=int, default=5, help='number of gconv layers')
        parser.add_argument('--lr', default=0.1, type=float, help='initial learning rate')
        parser.add_argument('--wd', default=5e-5, type=float, help='weight decay')
        parser.add_argument('--num_iter', default=1000, type=int, help='number of epochs for training')
